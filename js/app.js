...
function scrollBottomHeader() {
	const headerTopHeight = headerTop.offsetHeight;
     ...
     if (windowScrollTop >= headerTopHeight) {
          headerBottom.classList.add("_fix");
          page.classList.add("_scroll-page");
          const pageFix = document.querySelector("._scroll-page");
          if (pageFix) {
               pageFix.style.marginTop = `${headerBottomHeight}px`;
          }
     } else {
          headerBottom.classList.remove("_fix");
          page.classList.remove("_scroll-page");
          page.style.marginTop = "0px";
     }
}
scrollBottomHeader();
if (headerTop && headerBottom) {
	document.addEventListener("scroll", scrollBottomHeader);
	window.addEventListener("resize", scrollBottomHeader);
}
...
const accessoriesSlider = new Swiper(".accessories-slider__container", {
     navigation: {
          nextEl: ".accessories-slide__arrow._arrow-next",
          prevEl: ".accessories-slide__arrow._arrow-prev",
     },
     speed: 800,
     slidesPerView: 7,
     spaceBetween: 20,
